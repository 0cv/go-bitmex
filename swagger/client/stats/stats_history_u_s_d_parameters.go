...
// NewStatsHistoryUSDParams creates a new StatsHistoryUSDParams object
// with the default values initialized.
func NewStatsHistoryUSDParams() *StatsHistoryUSDParams {

	return &StatsHistoryUSDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewStatsHistoryUSDParamsWithTimeout creates a new StatsHistoryUSDParams object
...
// NewStatsHistoryUSDParamsWithContext creates a new StatsHistoryUSDParams object
...
// NewStatsHistoryUSDParamsWithHTTPClient creates a new StatsHistoryUSDParams object
...
/*StatsHistoryUSDParams contains all the parameters to send to the API endpoint
for the stats history u s d operation typically these are written to a http.Request
*/
