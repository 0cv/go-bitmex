...
// NewLiquidationGetParams creates a new LiquidationGetParams object
...
// NewLiquidationGetParamsWithTimeout creates a new LiquidationGetParams object
...
// NewLiquidationGetParamsWithContext creates a new LiquidationGetParams object
...
// NewLiquidationGetParamsWithHTTPClient creates a new LiquidationGetParams object
...
/*LiquidationGetParams contains all the parameters to send to the API endpoint
for the liquidation get operation typically these are written to a http.Request
*/
...
func (o *LiquidationGetParams) WithContext(ctx context.Context) *LiquidationGetParams {
	o.SetContext(ctx)
	return o
}
