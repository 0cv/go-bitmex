...
// NewSettlementGetParams creates a new SettlementGetParams object
...
// NewSettlementGetParamsWithTimeout creates a new SettlementGetParams object
...
// NewSettlementGetParamsWithContext creates a new SettlementGetParams object
...
// NewSettlementGetParamsWithHTTPClient creates a new SettlementGetParams object
...
/*SettlementGetParams contains all the parameters to send to the API endpoint
for the settlement get operation typically these are written to a http.Request
*/
type SettlementGetParams struct {
