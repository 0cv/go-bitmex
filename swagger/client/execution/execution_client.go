...
*/
func (a *Client) ExecutionGet(params *ExecutionGetParams) (*ExecutionGetOK, error) {
...
*/
func (a *Client) ExecutionGetTradeHistory(params *ExecutionGetTradeHistoryParams) (*ExecutionGetTradeHistoryOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
