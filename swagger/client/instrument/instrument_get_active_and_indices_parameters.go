...
// NewInstrumentGetActiveAndIndicesParams creates a new InstrumentGetActiveAndIndicesParams object
// with the default values initialized.
func NewInstrumentGetActiveAndIndicesParams() *InstrumentGetActiveAndIndicesParams {

	return &InstrumentGetActiveAndIndicesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewInstrumentGetActiveAndIndicesParamsWithTimeout creates a new InstrumentGetActiveAndIndicesParams object
...
// NewInstrumentGetActiveAndIndicesParamsWithContext creates a new InstrumentGetActiveAndIndicesParams object
...
// NewInstrumentGetActiveAndIndicesParamsWithHTTPClient creates a new InstrumentGetActiveAndIndicesParams object
...
/*InstrumentGetActiveAndIndicesParams contains all the parameters to send to the API endpoint
for the instrument get active and indices operation typically these are written to a http.Request
*/
type InstrumentGetActiveAndIndicesParams struct {
