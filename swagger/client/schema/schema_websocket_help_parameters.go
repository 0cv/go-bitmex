...
// NewSchemaWebsocketHelpParams creates a new SchemaWebsocketHelpParams object
// with the default values initialized.
func NewSchemaWebsocketHelpParams() *SchemaWebsocketHelpParams {

	return &SchemaWebsocketHelpParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewSchemaWebsocketHelpParamsWithTimeout creates a new SchemaWebsocketHelpParams object
...
// NewSchemaWebsocketHelpParamsWithContext creates a new SchemaWebsocketHelpParams object
...
// NewSchemaWebsocketHelpParamsWithHTTPClient creates a new SchemaWebsocketHelpParams object
...
/*SchemaWebsocketHelpParams contains all the parameters to send to the API endpoint
for the schema websocket help operation typically these are written to a http.Request
*/
